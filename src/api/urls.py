...
urlpatterns = [
    ...
    url(r'^change-euro-eusko/$', bdc_cyclos_views.change_euro_mlc),
    url(r'^change-euro-eusko-numeriques/$', bdc_cyclos_views.change_euro_mlc_numeriques),
    ...
    url(r'^sortie-retour-eusko/$', bdc_cyclos_views.sortie_retour_mlc),
    url(r'^depot-eusko-numerique/$', bdc_cyclos_views.depot_mlc_numerique),
    url(r'^retrait-eusko-numerique/$', bdc_cyclos_views.retrait_mlc_numerique),
    ...
    url(r'^payments-available-entrees-eusko/$', gi_views.payments_available_for_entrees_mlc),
    ...
    url(r'^paiement-cotisation-eusko-numerique/$', gi_views.paiement_cotisation_mlc_numerique),
